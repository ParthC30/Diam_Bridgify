...
import { changeTrust, createWallet, encrypt, transferAssets } from "../utils/utils";
...
const CreateWallet = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.info('Transfering 80 USDC', {
        position: "top-right",
        autoClose: 2500,
        hideProgressBar: false,
        closeOnClick: true,
      ...
      await transferAssets(protocolPair, userPair.publicKey(), usdc, '80');
            ...
            >
              ...
              <div className="flex justify-between w-full mt-10">
                {submit ? (
                  ...
                  <button
                    type="submit"
                    className="bg-purple-600 hover:bg-purple-800 cursor-pointer h-12 w-36 rounded-lg text-lg text-white font-bold"
                  >
                    Login
                  </button>
                )}
